...
## 2. Why and when do we use AutoCAD?
AutoCAD has been extensively used in construction. There are applications in other industries, and the following are examples of why and when it is used:
